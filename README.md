...
📌 Project Overview This project is a game titled 'CatchAlphabets', built using Assembly Language. The game simulates falling alphabets that need to be caught using a movable box at the bottom of the screen.                                                                   🎮 Game Features & Requirements                                                                                                            • ➡ The game starts on launching the program in DOSBox. 
